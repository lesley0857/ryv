...
class RyvmAppMember(models.Model):
    ...
    email_request = models.IntegerField()
    ...
    class Meta:
        ...
        db_table = 'ryvm_app_member'





class RyvmAppPictureClergy(models.Model):
    ...
    class Meta:
        ...
        db_table = 'ryvm_app_picture_clergy'
